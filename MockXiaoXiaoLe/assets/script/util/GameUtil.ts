import { SlidDirection, TileType } from "../type/Enum";
import GameConfig from "../config/GameConfig";
import { Combination, Coord, Coordinate } from "../type/DataStructure";
import { Vec2 } from "cc";
...
export default class GameUtil {
    ...
    * @param endPos 结束位置
    */
    public static getSlidDirection(startPos: Vec2, endPos: Vec2): SlidDirection {
